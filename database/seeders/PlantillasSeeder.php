...
class PlantillasSeeder extends Seeder
{
    ...
    private function seccionEncabezado(string $subtipo): array
    {
        return [
            ...
            'orden'       => 1,
            'obligatoria' => true,
            'instrucciones' => 'Redacta el encabezado dirigido al Juez Público de Turno en lo Civil de la jurisdicción correspondiente. Incluye el nombre del tribunal o juzgado. Usa formato boliviano formal en mayúsculas para el tratamiento del juez.',
            'retrieval' => [
                'fuentes' => [
    ...
    private function seccionTipoDemanda(string $subtipo, string $titulo): array
    {
        return [
            ...
            'orden'       => 2,
            'obligatoria' => true,
            'instrucciones' => "Redacta una sola línea que identifique el tipo de proceso. Debe decir exactamente: \"{$titulo}\"",
            'retrieval' => [
                'fuentes' => [
    ...
    private function seccionGenerales(string $subtipo): array
    {
        return [
            ...
            'orden'       => 4,
            'obligatoria' => true,
            'instrucciones' => 'Redacta las generales de ley del demandante. Incluye: nombre completo en MAYÚSCULAS, "mayor de edad, hábil por derecho", estado civil, profesión u ocupación, domicilio, número de Cédula de Identidad con extensión departamental. Cierra con la fórmula: "ante su Autoridad con respeto expongo y pido:"',
            'retrieval' => [
                'fuentes' => [
    ...
    private function seccionCierre(): array
    {
        return [
            ...
            'orden'       => 99,
            'obligatoria' => true,
            'instrucciones' => 'Redacta el cierre de la demanda con ciudad y fecha en letras (ej: "Santa Cruz de la Sierra, veintiuno de mayo de dos mil veintiséis"). Deja dos líneas en blanco para las firmas del abogado y la parte demandante.',
            'retrieval' => ['fuentes' => []],
            'salida' => [
                'estructurado' => '{contenido}',
                'corrido'      => '{contenido}',
        ...
        return [
            ...
            'secciones'      => [
                ...
                [
                    ...
                    'orden'       => 6,
                    'obligatoria' => true,
                    'instrucciones' => 'Genera los otrosíes de la demanda de desalojo: OTROSI 1.- Prueba documental (título de propiedad, plano arquitectónico, pago de impuestos, contrato de alquiler o anticrético si corresponde). OTROSI 2.- Declaración jurada de necesidad propia (si aplica). OTROSI 3.- Arancel del Colegio de Abogados. OTROSI 4.- Croquis de referencia del inmueble para notificación. OTROSI 5.- Domicilio procesal del abogado. OTROSI 6.- Citaciones y notificaciones por servidor público de la Policía Judicial.',
                    'retrieval' => [
                        'fuentes' => [
        ...
        return [
            ...
            'secciones'      => [
                ...
                [
                    ...
                    'orden'       => 5,
                    'obligatoria' => false,
                    'instrucciones' => 'Si el demandante actúa mediante mandato (poder notarial), redactá la sección de personería: número de escritura del poder, notario otorgante, fecha, protocolo y facultades conferidas. Si actúa por derecho propio, omite esta sección (sección opcional).',
                    'retrieval' => [
                        'fuentes' => [
                ...
                [
                    ...
                    'orden'       => 6,
                    'obligatoria' => true,
                    'instrucciones' => 'Narra los hechos del caso en orden cronológico. Comienza con "Señor juez, en fecha [...]" o "Señora juez...". Usa tercera persona o primera persona según sea más natural. Menciona documentos probatorios cuando corresponda (fechas, notarios, folios reales, matrículas, etc.). Estructura en párrafos coherentes y no saltes en el tiempo sin transición. Sé específico con fechas, montos y documentos.',
                    'retrieval' => [
                        'fuentes' => [
                ...
                [
                    ...
                    'orden'       => 7,
                    'obligatoria' => true,
                    'instrucciones' => 'Cita los artículos del Código Civil y/o Código Procesal Civil boliviano aplicables al caso. Para cada artículo: mencioná el número y nombre, citá el texto pertinente de los chunks entregados, explica brevemente su aplicación al caso. Solo usá artículos entregados en las referencias legales. NO inventes numeraciones ni textos de artículos.',
                    'retrieval' => [
                        'fuentes' => [
                ...
                [
                    ...
                    'orden'       => 8,
                    'obligatoria' => true,
                    'instrucciones' => 'Redacta la petición concreta al juez. Comienza con "Con todo lo expuesto anteriormente es que solicito a su autoridad declare probada la demanda con costas y costos, en consecuencia [PRETENSIÓN ESPECÍFICA]." Adapta la pretensión según el tipo de demanda: Nulidad → declarar nulidad del instrumento + devolución; Usucapión → otorgar propiedad sobre el inmueble + notificar a Derechos Reales + cancelar gravámenes; Regularización → declarar propietario + inscripción en DDRR. Usa fórmulas formales bolivianas.',
                    'retrieval' => [
                        'fuentes' => [
