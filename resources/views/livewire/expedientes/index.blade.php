<div>
    ...
    <div class="flex items-center justify-between mb-5 gap-4">
        ...
        <a href="{{ route('expedientes.create') }}" wire:navigate
           class="inline-flex items-center gap-1.5 h-8 px-3 bg-slate-900 text-white text-xs font-medium rounded-md hover:bg-slate-800 transition-colors flex-shrink-0">
